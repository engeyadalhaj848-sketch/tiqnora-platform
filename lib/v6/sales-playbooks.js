...
function mergedFields(input = {}) {
  ...
  return {
    ...
    ...(input.qualification || {}),
    ...(input.custom_fields || {}),
    has_website: input.has_website ?? lead.custom_fields?.has_website ?? (lead.website ? true : undefined),
    has_whatsapp_business: input.has_whatsapp_business ?? lead.custom_fields?.has_whatsapp_business ?? (lead.whatsapp ? true : undefined),
